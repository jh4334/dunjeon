...
| 직업 | 해금 | 특징 |
|---|---|---|
| 🛡️ 기사 | 무료 | 근접 강타 + 방패 (근접 100%) |
| 💀 네크로맨서 | 300 G | 6초마다 **해골 미니언** 소환(최대 3). 리더를 따라다니며 인접 적을 공격하고, 몬스터 어그로를 대신 받아 탱킹 (근접 40%) |
| 💣 폭탄공 | 500 G | 이동할 때마다 지나온 칸에 **지뢰** 설치(쿨 1.2초, 최대 6). 밟으면 주변 1칸에 공격력 ×1.8 폭발 (근접 60%) |
| 🗡️ 블레이드 댄서 | 800 G | 근접 공격 대신 **회전 칼날 오라** — 0.5초마다 주변 8칸 전원에게 공격력 45% |
