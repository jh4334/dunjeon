...
초원 캠프 옆 비석에 다가가면 열립니다 — 최고 깊이 / **직업별 최고 깊이** / 총 채굴 광맥 수 /
...
| `강화` 버튼 (초원) | ⚒️ 모닥불 캠프 — 영구 강화 · ◆ 광산 장비 · 난이도 변경 · 🎭 직업 변경 |
...
- **WebAudio 신스 SFX 16종** — 타격·치명타·처치·골드·힐·레벨업·경고·강타·보스·전멸·UI·계단·곡괭이·아주라이트·플레어·어둠. 외부 오디오 파일 없이 오실레이터로 합성하며, 첫 입력에서 오디오를 해제합니다(모바일 autoplay 정책). 연타 타격음은 60ms 스로틀
...
- 🪦 깊이 기록(직업별 최고 깊이 · 채굴 광맥 수 · 누적 아주라이트 · 최다 킬)
