...
window.GAME = {
  ...
  /* ---- M7b: 젬 대확장 / 각성젬 / 젬 콤보 ---- */
  SKILL_GEM_DEFS, SUPPORT_GEM_DEFS, AWAKENED_GEM_DEFS,
  SKILL_GEM_KEYS, SUPPORT_GEM_KEYS, AWAKENED_GEM_KEYS, NORMAL_GEM_KEYS,
  CASTER_GEM_KEYS, HEAL_GEM_KEYS, MELEE_GEM_KEYS,
  GEM_TAGS, GEM_TAG_KEYS, COMBO_LABELS, AW_MUL, AW_EXTRA,
  AW_DEPTH, AW_BOSS_P, AW_SHOP_DEPTH, AW_SHOP_P,
  gemDef, gemBaseKey, gemIsAwakened, gemAwMul, awakenedKeyOf, gemTags, gemHasTag,
  isCasterGem, isHealGem, isMeleeGem, supportActive, comboLabel, comboLine,
  rollGemKey, awakenedDropChance,
  SUPPORT2_LV, GEM_SLOTS, support2Unlocked, slotUnlocked, slotLv,
  equippedSupports, comboPreview,
  // 젬 스킬 엔진 (테스트 훅 — 실시간 대기 없이 직접 발동)
  SKILL_CAST, SKILL_CAST_KEYS, castSkill, blastAt, blastGemFx, gemDamage,
  applyConvert, gemTrigger, gemHeal, nextForkTarget, minionSplitMul,
  spawnGemZone, updateGemZones, scheduleGemCast, scheduleGemBlast, updateGemCasts,
  gemZones: () => gemZoneList(),
  gemCasts: () => gemCastList(),
  corpses: () => (state.world && state.world.corpses) || [],
  FORK_MUL, ECHO_DELAY, ECHO_MUL, MULTI_P, SIPHON_RATE, SACRIFICE_COST,
  TRIGGER_P, METEOR_DELAY, GEM_ZONE_TICK, GEM_CD,
